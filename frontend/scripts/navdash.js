...
export default class DashboardView {
    ...
    async updateTransactions() {
        ...
        <div class="d-flex align-items-center column-gap-2 m-3">
            <div class="w-100 d-flex flex-column">
                ...
                <div class="d-flex column-gap-2 align-items-center" style="color: var(--bs-tertiary-color);">
                    ...
                    <span class="fw-bold" {{HIDDEN_RESPONSABLE}}>{{RESPONSABLE}}</span>
                    ...
                    <span class="fw-bold" {{HIDDEN_CARD}}>{{CARD}}</span>
                </div>
            </div>
            <span class="title-3-bold">R$</span>
            <span class="fs-3 fw-semibold" style="color: {{VALUE_COLOR}};">{{VALUE}}</span>
        </div>
        `;
        ...
        this.#jquery.find('#num-transactions').text(response.length);
    }
